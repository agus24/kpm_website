  ...
  >
    <div class="container">
      <div class="row">
        ...
        >
          <p>Kualitas Prima Mandiri (KPM) is a training provider and mystery shopping agency company that is build by perfection, enthusiasm and passion for the field.</p>
          <div class="row">
